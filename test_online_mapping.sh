...
echo ""
echo "Expected input topic:"
echo "  - /synced_frame (sgloop_ros/SyncedFrame)"
echo ""
echo "SyncedFrame message contains:"
echo "  - Header header"
echo "  - sensor_msgs/Image rgb"
echo "  - sensor_msgs/Image depth"
echo "  - sensor_msgs/Image mask"
echo "  - geometry_msgs/Pose pose"
echo "  - string json"
